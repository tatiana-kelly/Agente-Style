...
export const STYLE_RULES: Record<Style, StyleRule> = {
  social: {
    ...
    preferredSubcategories: { top: ['camisa', 'blusa'], bottom: ['calca', 'saia'], shoes: ['salto', 'sapato', 'sapatilha'], outerwear: ['blazer'] },
  ...
  trabalho: {
    ...
    requiredRoles: ['top', 'bottom', 'shoes'], optionalRoles: ['outerwear', 'accessory', 'bag'],
    preferredSportTypes: ['nenhum'], forbiddenSubcategories: SOCIAL_FORBIDDEN,
    preferredSubcategories: { top: ['camisa', 'blusa', 'polo'], bottom: ['calca', 'saia'], shoes: ['sapatilha', 'sapato', 'salto'], outerwear: ['blazer'] },
